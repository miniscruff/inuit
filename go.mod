module github.com/miniscruff/inuit

go 1.18

require (
	github.com/hajimehoshi/ebiten/v2 v2.4.7
	github.com/miniscruff/igloo v0.3.0
)
...
// if you want to work locally uncomment this
replace github.com/miniscruff/igloo => ../igloo
